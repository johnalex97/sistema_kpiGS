    ...
    await expect(
      database.resultadoKPI.create({
        data: {
          ...
          completedCredits: "1.0000",
          appliedTarget: 1,
          registeredMinutes: 60,
          productiveMinutes: 60,
          eligibleCredits: "1.0000",
          onTimeEligibleCredits: "1.0000",
          attributableRecurrenceCredits: "0.0000",
          ...
          productivityEffectiveWeight: "0.3000",
          complianceEffectiveWeight: "0.2500",
          efficiencyEffectiveWeight: "0.2000",
          qualityEffectiveWeight: "0.2500",
        },
      }),
    ).rejects.toThrow();
  });
