      ...
      <main>
        <header className="topbar">
          ...
          <div className="topbar-actions">
            <label className="search"><Search size={17} aria-hidden="true" /><span className="sr-only">Buscar orden, cliente o técnico</span><input value={search} onChange={(event) => setSearch(event.target.value)} placeholder="Buscar orden, cliente..." aria-label="Buscar orden, cliente o técnico" /><kbd aria-hidden="true">⌘ K</kbd></label>
