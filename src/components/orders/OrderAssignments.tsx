...
export function OrderAssignments({ order, lookupApi, pending, error, onAssign, onUnassign }: OrderAssignmentsProps) {
  ...
  return <section className="order-assignments" aria-label="Administrar equipo">
    <header><div><span>EQUIPO EN CAMPO</span><h3>Asignaciones</h3></div><strong>{participants.filter((item) => item.active).length} activos</strong></header>
    ...
    <div className="order-assignments__editor">
