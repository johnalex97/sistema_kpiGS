...
function qualityScore(kpi: KpiDashboardItem | undefined): string {
  if (!kpi) return "Sin cálculo";
  return kpi.qualityScore ?? "No aplica";
}
...
export function TechnicianTable({ technicians, kpis, showKpi, onSelect }: TechnicianTableProps) {
  return <div className="technicians-table-wrap"><table className="technicians-table">
    <thead><tr><th>Técnico</th><th>Especialidad</th><th>Estado</th>{showKpi && <><th>KPI semanal</th><th>Calidad real</th><th>Completado / meta</th><th>Tiempo productivo</th></>}<th>Usuario vinculado</th><th><span className="sr-only">Detalle</span></th></tr></thead>
