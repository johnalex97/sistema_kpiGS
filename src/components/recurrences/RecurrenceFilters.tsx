  ...
  return <div className="recurrence-filters-region">
    <div className="recurrence-filters" aria-label="Filtros de reincidencias">
      ...
      {canViewAll && <div className="recurrence-filters__scope" aria-label="Filtros globales">
        <label><span>Orden original</span><input name="recurrenceOriginalOrder" autoComplete="off" spellCheck={false} value={scopeDraft.originalOrderId} onChange={(event) => updateScopeDraft("originalOrderId", event.target.value)} placeholder="Ej. 123e4567-e89b-12d3-a456-426614174000…" /></label>
        <label><span>Técnico</span><input name="recurrenceTechnician" autoComplete="off" spellCheck={false} value={scopeDraft.technicianId} onChange={(event) => updateScopeDraft("technicianId", event.target.value)} placeholder="Ej. 123e4567-e89b-12d3-a456-426614174000…" /></label>
        <label><span>Cliente</span><input name="recurrenceClient" autoComplete="off" spellCheck={false} value={scopeDraft.clientId} onChange={(event) => updateScopeDraft("clientId", event.target.value)} placeholder="Ej. 123e4567-e89b-12d3-a456-426614174000…" /></label>
        <label><span>Sucursal</span><input name="recurrenceBranch" autoComplete="off" spellCheck={false} value={scopeDraft.branchId} onChange={(event) => updateScopeDraft("branchId", event.target.value)} placeholder="Ej. 123e4567-e89b-12d3-a456-426614174000…" /></label>
